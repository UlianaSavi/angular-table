...
Аn application with a table. 
The table can be sorted and a search function is performed. 
The user can choose which columns of the table to show and which to hide.
